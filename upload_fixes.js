...
async function uploadFixes() {
    ...
    try {
        ...
        // 2. Upload local HTML files from Documents/GitHub/Celzimo veste web to /_archivo-html-2026-07-03/
        const localSourceDir = "C:\\Users\\Cristobal\\Documents\\GitHub\\Celzimo veste web";
        ...
        for (const file of filesToUpload) {
            const localPath = path.join(localSourceDir, file);
        ...
        console.log("¡Todos los archivos han sido subidos y actualizados con éxito!");
    } catch (err) {
